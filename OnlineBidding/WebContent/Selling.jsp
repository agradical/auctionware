        ...
        <div class="col-sm-12 col-md-12 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-4 placeholder">
             <a href="#"> <img src="img/mobile.jpeg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
              <a href="#"><h4>Phones</h4></a>
            </div>
            <div class="col-xs-6 col-sm-4 placeholder">
              <a href="#"><img src="img/laptop.jpeg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
              <a href="#"><h4>Laptops</h4></a>
            </div>
            <div class="col-xs-6 col-sm-4 placeholder">
              <a href="#"><img src="img/tablet.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail"></a>
              <a href="#"><h4>Tablets</h4></a>
            </div>
          </div>
